var default_image_url = "//codecloud.cdn.speedyrails.net/sites/5d8baf086e6f641798050000/image/png/1546964185000/aberdeenlogo.png"
...
function renderEventDetails(container, template, collection, mall_name){
    ...
    $.each( item_list , function( key, val ) {
        if (val.eventable_type == "Store") {
            ...
            val.store_image = "//codecloud.cdn.speedyrails.net/sites/5d8baf086e6f641798050000/image/png/1546964185000/aberdeenlogo.png";
