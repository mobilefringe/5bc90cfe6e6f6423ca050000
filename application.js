var default_image_url = "//codecloud.cdn.speedyrails.net/sites/5c82c7ee6e6f6463c7040000/image/png/1546964185000/aberdeenlogo.png"
...
function renderEventDetails(container, template, collection, mall_name){
    ...
    $.each( item_list , function( key, val ) {
        if (val.eventable_type == "Store") {
            ...
            val.store_image = "//codecloud.cdn.speedyrails.net/sites/5c82c7ee6e6f6463c7040000/image/png/1546964185000/aberdeenlogo.png";
...
function renderFeatureItems(){
    ...
    $.each(items, function(i, val){
        if (val.name === "") {
            if(val.url === ""){
                $('#feature_' + i).html('<img src="'+ val.image_url+'" class="hoverer" alt="Feature Item ' +val.id+ '">')
            } else {
                $('#feature_' + i).html('<a href="'+ val.url +'"><img src="'+ val.image_url+'" class="hoverer" alt="Feature Item ' +val.id+ '"></a>')
            }
        } else {
